...
Then you should activate this environement before using the monitoring; this is required either when using an interactive session or a job. Use the command line: <br> 
...
All observations/Re-analyses data used in the monitoring to compare the model outputs with are available there [DataObs (~3GB)](https://data.umr-lops.fr/pub/FREDY_MONITOR/MISC/FOR-MONITORING_v2.tgz). This file can also be downloaded in command line. Create a directory in a permanent space, for instance DATAOBS.<br> 
