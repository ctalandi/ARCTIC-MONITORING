...
for var in DEF_INFO_VAR('gridT','votemper'):
    ...
    if read_IAinputdata == 1:
        ...
        if chkfile(locpath+locfile) :
            ...
            #print(' Reloaded data max value:'+ str(My_var.max())
            #print(' Reloaded data min value:'+ str(My_var.min())
